...
@Test
public class TC_StratergywoInputs_011 extends BaseClass {

	public void stratergyScreenWoInputs() throws InterruptedException
	{
		testLevelLog.get().assignCategory("Regression_Test_Suite");

		log=Logger.getLogger(TC_StratergywoInputs_011.class);
