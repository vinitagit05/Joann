...
public class TC_FinalizeAllocation_010 extends BaseClass {
	@Test
	public void finalizeAllocationScreen() throws InterruptedException
	{
		//testLevelLog.get().assignAuthor("Nandeesh CL");
			   ...
			   /* cap.clickNext2();
			    ...
			    boolean status=cap.checkScreen6Displayed();
